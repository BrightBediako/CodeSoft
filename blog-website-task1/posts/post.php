...
$comments = $conn->query("SELECT posts.id AS id, comments.id_post_comment AS id_post_comment, comments.user_name_comment AS user_name_comment, comments.comment AS comment, comments.created_at AS created_at, comments.status_comment AS status_comment FROM posts JOIN comments ON posts.id = comments.id_post_comment WHERE posts.id = '$id' AND comments.status_comment = 1");
            ...
            <div class="col-md-10 col-lg-8 col-xl-7">
                <div class="post-heading">
                    <h2><?php echo $post->title; ?></h1>
                        <h3 class="subheading"><?php echo $post->subtitle; ?></h3>
                        <span class="meta">
                            Posted by
